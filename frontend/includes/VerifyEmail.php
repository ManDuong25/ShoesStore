...
class VerifyEmail { 
    ...
    public function check($email) { 
        ...
        // Chỉ kiểm tra mã phản hồi liên quan đến sự tồn tại
        switch ($code) { 
            case '250': 
                // Email tồn tại
                return TRUE; // Email valid and exists
            case '550':
                // Email không tồn tại
                return FALSE; // Email valid but not exists
            default: 
                // Các mã khác không xác định rõ ràng
                return FALSE; 
        } 
    } 
